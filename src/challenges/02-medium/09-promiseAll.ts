...
type ResolvePromises<V extends unknown[]> = {
  [K in keyof V]: V[K] extends Promise<infer R> ? R : V[K];
};

declare function PromiseAll<V extends unknown[]>(
  values: readonly [...V]
): Promise<ResolvePromises<V>>;
